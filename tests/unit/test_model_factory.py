...
def test_create_filter_model_nested() -> None:
    ...
    expected_fields = {
        ...
        "f_post_title__between",
        "f_is_active__eq",
        "f_is_active__ne",
        "f_is_active__isnull",
        "f_is_active__not_isnull",
        "f_gate_address__eq",
        "f_gate_address__icontains",
        "f_gate_address__isnull",
        "f_gate_address__not_isnull",
        "f_gate_address__between",
        "f_casualties__eq",
        "f_casualties__gte",
        "f_casualties__isnull",
        "f_casualties__not_isnull",
        "f_casualties__between",
        "f_success_rate__gte",
        "f_success_rate__lte",
        "f_success_rate__between",
        "f_mission_report_url__eq",
        "f_mission_report_url__isnull",
        "f_mission_report_url__not_isnull",
        "f_tags__arr_contains",
        "f_tags__arr_overlap",
        "f_tags__arr_all",
        "f_tags__arr_any",
        "f_tags__arr_len",
        ...
        "f_mission_date__not_isnull",
        "f_mission_date__between",
        "f_mission_start__gte",
        "f_mission_start__lte",
        "f_mission_start__isnull",
        "f_mission_start__not_isnull",
        "f_mission_start__between",
        "f_incident_time__eq",
        "f_incident_time__gte",
        "f_incident_time__lte",
        "f_incident_time__isnull",
        "f_incident_time__not_isnull",
        "f_created_at__gte",
        "f_created_at__lte",
        ...
        "f_author__name__contains",
        "f_author__name__startswith",
        "f_author__name__istartswith",
        "f_author__name__endswith",
        "f_author__name__iendswith",
        "f_author__email__eq",
